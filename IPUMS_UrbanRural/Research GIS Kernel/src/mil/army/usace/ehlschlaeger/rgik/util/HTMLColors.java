...
/**
 * HTML color names. Converts between HTML colors and Java colors.
 * <P>
...
public class HTMLColors {
    ...
    private static void initColorsMap() {
        ...
        for (Field field : fields) {
            if (field.getType().isAssignableFrom(Color.class)) {
                try {
                    addColor(field.getName(), (Color) field.get(HTMLColors.class));
    ...
    // Must be at the bottom!  We need static members to be set first.
    static {
        initColorsMap();
    }
}
