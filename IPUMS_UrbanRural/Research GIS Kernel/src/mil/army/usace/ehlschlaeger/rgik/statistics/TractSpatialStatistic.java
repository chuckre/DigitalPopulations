...
public interface TractSpatialStatistic extends SpatialStatistic {
   /**
    ...
    //
    // DEVELOPER'S NOTE:
    // averageOff was pulled up from class Proportion. It might not make sense
    // for SpatialStatistics in general. But if it's removed from this class, a
    // bunch of code will need to be overhauled.
    //
}
