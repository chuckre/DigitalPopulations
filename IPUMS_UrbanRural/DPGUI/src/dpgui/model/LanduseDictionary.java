...
public class LanduseDictionary {
    ...
    public File makeMetadataFile(File mapFile) {
        if(mapFile == null)
            ...
            return FileUtil.resolve(mapFile.getParentFile(), mapFile.getName()+".metadata.csv");
    }
    ...
    public void loadMapMetadata(File mapFile) {
        ...
        try {
            ...
            // Ignore, we'll create a new file on save.
        }
    }
    ...
    public void saveDict() {
        ...
        try {
            ...
            // Ignore, there's nothing the user can do anyway.
