...
public class PointClusterDetector { 
	...
	public PointClusterDetector( CSVTable eventTable, String populationFilePrefix, int numberPopulationFiles,
			double maximumClusterDistance, double incrementDistance, GISGrid grid2check,
			double distanceDecayExponent, boolean detectMaximumClusters) throws IOException {
...
//System.out.print( i + ":" + test.getRowCount() + " ");
...
//System.out.println( "r: " + r + ", c: " + c + ", easting: " + easting + ", northing: " + northing);
				// doing event counts
					LinkedList<GISPoint> closePoints = events.getPoints( 
						new GISPoint( easting, northing), maximumClusterDistance);
...
//System.out.print( eventCount[ lag] + " ");
...
//System.out.println( "LL: " + closePoints.getNumberElements());
						GISPoint p = closePoints.remove();
						double popCount = 0.0;
						...
						while( p != null) {
							...
							double weight = td.getDouble( distanceP / d);
							popCount += weight;
							if( Math.random() < simPopIntensity[ i])
								simulatedEventCount += weight;
							p = closePoints.remove();
						}
						eventDensity[ i] = eventCount[ lag] / popCount;
//System.out.println( "simEventCount: " + simulatedEventCount + ", popCount: " + popCount);
...
//System.out.println( "countMoreExtreme: " + countMoreExtreme + ", bestNumberMoreExtreme: " + bestNumberMoreExtreme);
